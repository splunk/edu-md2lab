(function () {
    ...
    function pm() {
        ...
        return (
            (Hl.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = o),
            (Hl.createPortal = function (H, A) {
        ...
        function j0(l) {
            ...
            function S(m, y, d, z, p) {
                ...
                if (typeof z == 'object' && z !== null) {
                    ...
                    if (z.$$typeof === Nl) return S(m, y, d, Ve(y, z), p);
                    We(y, z);
                }
                return null;
            }
            ...
            function ul(m, y, d, z) {
                if (
                    ...
                    if (d.$$typeof === Nl) return ul(m, y, Ve(m, d), z);
                    We(m, d);
                }
...
`,
    ...
    var qm = Rm();
    function Ei(M) {
        const W = { a: 'a', p: 'p', strong: 'strong', ...M.components };
        return Rl.jsxs(Rl.Fragment, {
            children: [
                Rl.jsxs(W.p, {
                    children: [
                        'This page will appear at the ',
                        Rl.jsx(W.strong, { children: 'end' }),
...
`,
    ...
    function Cm(M = {}) {
        ...
        return W ? Rl.jsx(W, { ...M, children: Rl.jsx(Ei, { ...M }) }) : Ei(M);
    }
    function Bm() {
        return Rl.jsx('div', {
    ...
    function Ai() {
        ...
        (console.log('Found container:', M),
            ...
            qm.createRoot(M).render(Rl.jsx(Bm, {})),
